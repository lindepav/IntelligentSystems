...
#fit <- bayesglm(lbl ~ . , data=final, family="binomial")
fit = glm(lbl~., data=final, family="binomial", control = 5) # This doesnt complete for me but it should work
