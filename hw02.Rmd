...
create_model_date <- function(tdidf.matrix, avector) {
...
finalRf <- create_model_date(tfidf.matrixRf, avectorRf)
finalSVM <- create_model_date(tfidf.matrixSVM, avectorSVM)
