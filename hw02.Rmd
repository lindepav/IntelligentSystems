...
#my_palette <- palette(rainbow(16))
color <- grDevices::colors()[grep('gr(a|e)y', grDevices::colors(), invert = T)]
my_palette <- sample(color, n)
...
clusplot(points, cluster2.master, color=TRUE, shade=TRUE, labels=2, lines=0)
...
clusplot(points, cluster4.master, color=TRUE, shade=TRUE, labels=2, lines=0)
...
clusplot(points, cluster8.master, color=TRUE, shade=TRUE, labels=2, lines=0)
...
clusplot(points, cluster16.master, color=TRUE, shade=TRUE, labels=2, lines=0)
