...
# A function is non-convex (or concave) if for any {\displaystyle x}x and {\displaystyle y}y in the interval and for any
# {\displaystyle \alpha \in [0,1]}\alpha \in [0,1], the following equation is valid: 
...
res2 <- persp3D(x = x, y = y, z = z,theta = 30, phi = 25, col.palette = bl2gr.colors, ticktype = "detailed")
...
# this one, outside ofthe range of the subset. The global maximum is the largest overall value of the funtion.
