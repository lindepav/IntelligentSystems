...
plot(GA)
summary(GA)
res <- persp(x, y, z, theta = 40, phi = 20, expand = 1, col = "lightblue",
...
res2 <- persp(x, y, z, theta = 40, phi = 20, expand = 1, col = "lightblue",
      ltheta = 120, shade = 0.75, ticktype = "detailed")
#points (trans3d(history_x, history_y, z = f(history_x, history_y), pmat = res), col = "green")
#points(trans3d(history_x, history_y, z = f(history_x, history_y), pmat = res), col = "green", lwd = 1)
points(trans3d(history_x, history_y, z = f(history_x, history_y), pmat = res2), col = "red", lwd = 1, cex=0.3)
text(trans3d(history_x[1:3], history_y[1:3], z = f(history_x, history_y), pmat = res2), label = 25*c(1:3), col = "green", lwd = 0.3, pos=4, cex=0.35)
text(trans3d(history_x[10:12], history_y[10:12], z = f(history_x, history_y), pmat = res2), label = 25*c(10:12), col = "green", lwd = 0.3, pos=4, cex=0.35)
