...
persp3D(x, y, z, theta = 30, phi = 20, expand = 1, col = "lightblue")
```
...
{persp3D(x = x, y = x, z = z,theta = 30, phi = 25, col.palette = bl2gr.colors)
points3D(max_x, max_y, max_z, col = "blue", size = 300, add=T)}
