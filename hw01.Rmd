...
#lines3d (x, max_y, max_z, col = "blue")
#lines3d (max_x, y, max_z, col = "blue")
...
points3D(x = history_x, y = history_y, z = f(history_x, history_y), col = "black", size = 2, add=T)
text3D(x = history_x[1:3], y = history_y[1:3], z = f(history_x[1:3], history_y[1:3]), labels = 25*c(1:3), col = "black", pos=4, add=T)
text3D(x = history_x[10:12], y = history_y[10:12], z = f(history_x[10:12], history_y[10:12]), labels = 25*c(10:12), col = "black", pos=4, add=T)
